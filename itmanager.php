...
<body>
	...
	<header class="header-section sp-pad">
		<h3 class="site-logo">IT Manager</h3>
	...
	<div class="page-top-area set-bg" data-setbg="img/headers-bg/3.jpg">
		<div class="breadcrumb-area">
			<a href="index.php">Home</a> / <span>IT MANAGER</span>
		</div>
	</div>
		...
		<div class="container-fluid p-0">
			...
			<div class="row">
				<div class="col-xl-5">
					<ul class="work-info-list">
						<li>
							...
							<h4>Minimal Pengalaman di Bidang IT 5 Tahun</h4>
						</li>
						<li>
							<span>Gaji :</span>
							<h4>15 - 25 Juta / Bulan</h4>
						</li>
						<li>
				...
				<div class="col-xl-6 offset-xl-1">
					<span class="sp-sub-title">IT Manager</span>
					<h3 class="sp-title">Bertugas untuk :</h3>
					<p> Memimpin jalannya perusahaan, membuat relasi kerja sama dengan perusahaan lain,
                        mengatur kelancaran dari sistem IT, troubleshooting dan membantu organisasi
                        dalam menangani permasalahan IT, dan sesuai dengan pengembangan IT 
                        yang baru dalam bidang yang diperlukan</p>
				</div>
			</div>
		</div>
	</section>
