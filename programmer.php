...
<body>
	...
	<header class="header-section sp-pad">
		<h3 class="site-logo">Programmer</h3>
	...
	<div class="page-top-area set-bg" data-setbg="img/headers-bg/3.jpg">
		<div class="breadcrumb-area">
			<a href="index.php">Home</a> / <span>PROGRAMMER</span>
		</div>
	</div>
		...
		<div class="container-fluid p-0">
			...
			<div class="row">
				<div class="col-xl-5">
					<ul class="work-info-list">
						<li>
							...
							<h4>Minimal S1 Jurusan IT</h4>
						</li>
						<li>
							<span>Gaji :</span>
							<h4>8 - 15 Juta / Bulan</h4>
						</li>
						<li>
				...
				<div class="col-xl-6 offset-xl-1">
					<span class="sp-sub-title">Programmer</span>
					<h3 class="sp-title">Bertugas untuk :</h3>
					<p> Merealisasikan permintaan client melalui Flow Chart dan arahan dari
                        System Analys, mengambil bagian dalam pengembangan dan integrasi 
                        ...
                        diselesaikan, menyediakan dukungan dan penyelesaian masalah konsumen baik 
                        ...
                        kekompakan maksimum dalam perusahaan bersama dengan rekan-rekan dalam perusahaan.</p>
				</div>
			</div>
		</div>
	</section>
