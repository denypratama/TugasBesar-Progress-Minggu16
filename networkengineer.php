...
<body>
	...
	<header class="header-section sp-pad">
		<h3 class="site-logo">Network Engineer</h3>
	...
	<div class="page-top-area set-bg" data-setbg="img/headers-bg/3.jpg">
		<div class="breadcrumb-area">
			<a href="index.php">Home</a> / <span>Network Engineer</span>
		</div>
	</div>
				...
				<div class="col-xl-5">
					<ul class="work-info-list">
						<li>
							...
							<h4>Menguasai Cisco Networking</h4>
						</li>
						<li>
							<span>Gaji :</span>
							<h4>20 - 25 Juta / Bulan</h4>
						</li>
						<li>
							<span>Kisaran Umur :</span>
							<h4>28 - 40 Tahun</h4>
						</li>
					</ul>
				</div>
				<div class="col-xl-6 offset-xl-1">
					<span class="sp-sub-title">Network Engineer</span>
					<h3 class="sp-title">Bertugas untuk :</h3>
					<p> Melaksanakan komunikasi dan analisa sistem networking, 
                        mendesain perencanaan untuk integrasi, mendukung jaringan pada internet, 
                        intranet dan ekstranet, serta menganalisa dan ikut mengambil bagian dalam 
                        pengembangan standardisasi keamanan dan implementasi mengendalikan 
                        untuk keamanan LAN dan WAN. maintenance LAN dan koneksi internet, maintenance hardware, 
                        maintenance database dan file, help desk, dan inventory.</p>
				</div>
			</div>
		</div>
	</section>
