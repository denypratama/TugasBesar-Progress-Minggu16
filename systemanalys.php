...
<body>
	...
	<header class="header-section sp-pad">
		<h3 class="site-logo">System Analys</h3>
	...
	<div class="page-top-area set-bg" data-setbg="img/headers-bg/3.jpg">
		<div class="breadcrumb-area">
			<a href="index.php">Home</a> / <span>System Analys</span>
		</div>
	</div>
		...
		<div class="container-fluid p-0">
			...
			<div class="row">
				<div class="col-xl-5">
					<ul class="work-info-list">
						<li>
							...
							<h4>Minimal Pengalaman sebagai Programmer 2 Tahun</h4>
						</li>
						<li>
							<span>Gaji :</span>
							<h4>10 - 15 Juta / Bulan</h4>
						</li>
						<li>
				...
				<div class="col-xl-6 offset-xl-1">
					<span class="sp-sub-title">System Analys</span>
					<h3 class="sp-title">Bertugas untuk :</h3>
					<p>Berhadapan dengan client untuk software yang akan dibangun,
                        sebagai jembatan antara client dan programmer, merancang, membuat kode program, flow chart dan 
                        menguji program untuk mendukung perencanaan pengembangan aplikasi sistem</p>
				</div>
			</div>
		</div>
	</section>
